...
public class Date implements Serializable, Cloneable, Comparable<Date> {
	 ...
	 *
	 * @param date a Date instance to compare.
	 ...
	 *
	 * @param date a {@code Date} instance to compare.
	 ...
	 * ordering.
	 *
	 * @param date a {@code Date} to compare against.
	...
	@Deprecated
	public int getYear() {
		return getCal().get(Calendar.YEAR) - 1900;
	}
	...
	private static int zone(String text) {
		if (text.equals("EST")) return -5;
		if (text.equals("EDT")) return -4;
		if (text.equals("CST")) return -6;
		if (text.equals("CDT")) return -5;
		if (text.equals("MST")) return -7;
		if (text.equals("MDT")) return -6;
		if (text.equals("PST")) return -8;
		if (text.equals("PDT")) return -7;
		return 0;
	}

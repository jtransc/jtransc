...
public class Memory {
	...
	public static long peekAlignedLongBE(byte[] src, int offset) {
		return Long.reverseBytes(peekAlignedLongBE(src, offset));
	}

	public static float peekAlignedFloatBE(byte[] src, int offset) {
		return Float.intBitsToFloat(peekAlignedIntLE(src, offset));
	}

	public static double peekAlignedDoubleBE(byte[] src, int offset) {
		return Double.longBitsToDouble(peekAlignedLongLE(src, offset));
	}

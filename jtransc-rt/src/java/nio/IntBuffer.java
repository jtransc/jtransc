 ...
 * <li>Use {@link ByteBuffer#asIntBuffer() ByteBuffer.asIntBuffer} to
...
public abstract class IntBuffer extends Buffer implements Comparable<IntBuffer> {
    ...
    public static IntBuffer wrap(int[] array, int start, int intCount) {
        JTranscArrays.checkOffsetAndCount(array.length, start, intCount);
    ...
    public IntBuffer get(int[] dst, int dstOffset, int intCount) {
        JTranscArrays.checkOffsetAndCount(dst.length, dstOffset, intCount);

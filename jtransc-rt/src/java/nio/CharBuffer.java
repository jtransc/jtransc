 ...
 * new buffer;</li>
 * <li>Use {@link ByteBuffer#asCharBuffer() ByteBuffer.asCharBuffer}
...
public abstract class CharBuffer extends Buffer implements
    ...
    public static CharBuffer wrap(char[] array, int start, int charCount) {
		JTranscArrays.checkOffsetAndCount(array.length, start, charCount);
    ...
    public CharBuffer put(char[] src, int srcOffset, int charCount) {
        JTranscArrays.checkOffsetAndCount(src.length, srcOffset, charCount);
        if (charCount > remaining()) {

 ...
 * buffer;</li>
 * <li>Use {@link ByteBuffer#asShortBuffer() ByteBuffer.asShortBuffer}
...
public abstract class ShortBuffer extends Buffer implements
    ...
    public static ShortBuffer wrap(short[] array, int start, int shortCount) {
        JTranscArrays.checkOffsetAndCount(array.length, start, shortCount);
    ...
    public ShortBuffer get(short[] dst, int dstOffset, int shortCount) {
        JTranscArrays.checkOffsetAndCount(dst.length, dstOffset, shortCount);
    ...
    public ShortBuffer put(short[] src, int srcOffset, int shortCount) {
        JTranscArrays.checkOffsetAndCount(src.length, srcOffset, shortCount);
        if (shortCount > remaining()) {

 ...
 * buffer;</li>
 * <li>Use {@link ByteBuffer#asFloatBuffer() ByteBuffer.asFloatBuffer}
...
public abstract class FloatBuffer extends Buffer implements
    ...
    public static FloatBuffer wrap(float[] array, int start, int floatCount) {
        JTranscArrays.checkOffsetAndCount(array.length, start, floatCount);
    ...
    public FloatBuffer get(float[] dst, int dstOffset, int floatCount) {
        JTranscArrays.checkOffsetAndCount(dst.length, dstOffset, floatCount);

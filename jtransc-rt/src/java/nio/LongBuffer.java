 ...
 * buffer;</li>
 * <li>Use {@link ByteBuffer#asLongBuffer() ByteBuffer.asLongBuffer}
...
public abstract class LongBuffer extends Buffer implements
    ...
    public static LongBuffer wrap(long[] array, int start, int longCount) {
        JTranscArrays.checkOffsetAndCount(array.length, start, longCount);
    ...
    public LongBuffer get(long[] dst, int dstOffset, int longCount) {
        JTranscArrays.checkOffsetAndCount(dst.length, dstOffset, longCount);

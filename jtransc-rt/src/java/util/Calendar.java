...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
	 ...
	 *
	 * @throws IllegalArgumentException if the time cannot be computed from the current field
	 *                                  values.
	 */
	 ...
	 * @throws IllegalArgumentException if the argument does not include a valid time
	 *                                  value.
	 */

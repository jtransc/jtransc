...
public class IdentityHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Serializable, Cloneable {
    ...
    static class IdentityHashMapEntrySet<KT, VT> extends
        ...
        public boolean remove(Object object) {
            if (contains(object)) {
                associatedMap.remove(((Entry) object).getKey());
                return true;
            }
            return false;
        }
        ...
        public Iterator<Entry<KT, VT>> iterator() {
            return new IdentityHashMapIterator<Entry<KT, VT>, KT, VT>(
                    new MapEntry.Type<Entry<KT, VT>, KT, VT>() {
                        public Entry<KT, VT> get(MapEntry<KT, VT> entry) {
                            return entry;
                        }
                    }, associatedMap);
        }

...
public abstract class TimeZone implements Serializable, Cloneable {
	 ...
	 */
	native public static synchronized String[] getAvailableIDs(int offsetMillis);
	 ...
	 */
	native public static synchronized TimeZone getDefault();
	 ...
	 */
	native public String getDisplayName(boolean daylightTime, int style, Locale locale);

...
public class CharArrayWriter extends Writer {
     ...
     *
     * @param initialSize the initial size of this CharArrayWriters buffer.
     * @throws IllegalArgumentException if {@code initialSize < 0}.
     */
     ...
     * to this writer.
     *
     * @param buffer the non-null array containing characters to write.
     ...
     *
     * @param out the non-null {@code Writer} on which to write the contents.
     * @throws NullPointerException if {@code out} is {@code null}.
     * @throws IOException          if an error occurs attempting to write out the contents.
     */
     ...
     *
     * @param c the character appended to the CharArrayWriter.
     ...
     *
     * @param csq the {@code CharSequence} appended to the {@code
     ...
     * @param csq   the {@code CharSequence} appended to the {@code
     *              CharArrayWriter}, may be {@code null}.
     * @param start the index of the first character in the {@code CharSequence}
     *              appended to the {@code CharArrayWriter}.
     * @param end   the index of the character after the last one in the {@code

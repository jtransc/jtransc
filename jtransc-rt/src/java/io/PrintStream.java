...
public class PrintStream extends FilterOutputStream implements Appendable, Closeable {
     ...
     *
     * @param out         the target output stream.
     * @param autoFlush   indicates whether or not to flush contents upon encountering a
     *                    newline sequence.
     * @param charsetName the non-null string describing the desired character encoding.
     * @throws NullPointerException         if {@code out} or {@code charsetName} are {@code null}.
     * @throws UnsupportedEncodingException if the encoding specified by {@code charsetName} is not supported.
     */
     ...
     * @param file        the target file. If the file already exists, its contents are
     *                    removed, otherwise a new file is created.
     * @param charsetName the name of the character set used for character encoding.
     * @throws FileNotFoundException        if an error occurs while opening or creating the target file.
     ...
     *
     * @param charSequence the character sequence appended to the target stream.

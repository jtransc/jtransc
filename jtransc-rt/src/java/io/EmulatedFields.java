...
class EmulatedFields {
     ...
     *
     * @param fields   an array of ObjectStreamFields, which describe the fields to
     *                 be emulated (names, types, etc).
     * @param declared an array of ObjectStreamFields, which describe the declared
     *                 fields.
     */
     ...
     *
     * @param fields an array of ObjectStreamField, which describe the fields to be
     ...
     * @param fieldType the type of the field. This will be used to test
     ...
     * @param defaultValue return value in case the field has not been assigned to yet.
     * @return the value of the given field if it has been assigned, the default
     * value otherwise.
     * @throws IllegalArgumentException if the corresponding field can not be found.
     */

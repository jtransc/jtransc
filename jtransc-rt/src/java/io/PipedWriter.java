...
public class PipedWriter extends Writer {
     ...
     *
     * @param destination the {@code PipedReader} to connect to.
     * @throws IOException if {@code destination} is already connected.
     */
     ...
     * @throws IOException if this writer is closed or already connected, or if {@code
     ...
     *
     * @throws IOException if an I/O error occurs while flushing this writer.
     */
    @Override
     ...
     * @param count  the number of characters from {@code buffer} to write to this
     *               writer.
     ...
     *                                   handled correctly.
     * @throws IOException               if this writer is closed or not connected, if the target
